...
This means one can have an always-on erexd instance running, and another local erexd/erex-qt instance which connects to this node and receives blocks from it.
