...
RESOURCES += src/qt/erex.qrc src/qt/erex_locale.qrc

TRANSLATIONS += src/qt/locale/erex_bg.ts \
                src/qt/locale/erex_de.ts \
                src/qt/locale/erex_en.ts \
                src/qt/locale/erex_es.ts \
                src/qt/locale/erex_fi.ts \
                src/qt/locale/erex_fr.ts \
                src/qt/locale/erex_it.ts \
                src/qt/locale/erex_ja.ts \
                src/qt/locale/erex_pl.ts \
                src/qt/locale/erex_pt.ts \
                src/qt/locale/erex_ru.ts \
                src/qt/locale/erex_sk.ts \
                src/qt/locale/erex_sv.ts \
                src/qt/locale/erex_vi.ts \
                src/qt/locale/erex_zh_CN.ts \
                src/qt/locale/erex_zh_TW.ts
