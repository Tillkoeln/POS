...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("EREX RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  erex-cli [options] <command> [params]  " + _("Send command to EREX") + "\n" +
                        "  erex-cli [options] help                " + _("List commands") + "\n" +
                        "  erex-cli [options] help <command>      " + _("Get help for a command") + "\n";
