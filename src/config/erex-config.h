/* src/config/erex-config.h.  Generated from erex-config.h.in by configure.  */
/* src/config/erex-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef EREX_CONFIG_H

#define EREX_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.erex.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "EREX Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "EREX Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "erex"
