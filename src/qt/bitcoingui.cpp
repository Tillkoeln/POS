...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a EREX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and erex: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About EREX"), this);
    aboutAction->setStatusTip(tr("Show information about EREX"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EREX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EREX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EREX addresses"));
    ...
    openAction->setStatusTip(tr("Open a EREX: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the EREX help message to get a list with possible EREX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("EREX client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EREX network", "", count));
}
...
{
    QString strTitle = tr("EREX"); // default title
