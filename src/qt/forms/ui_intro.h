...
public:
    ...
    void setupUi(QDialog *Intro)
    {
        ...
        dataDirectory->setMinimumSize(QSize(36, 36));
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        label_2->setText(QApplication::translate("Intro", "Welcome to EREX", 0));
        label_4->setText(QApplication::translate("Intro", "As this is the first time the program is launched, you can choose where EREX will store its data.", 0));
        sizeWarningLabel->setText(QApplication::translate("Intro", "EREX will download and store a copy of the EREX block chain. At least %1GB of data will be stored in this directory, and it will grow over time. The wallet will also be stored in this directory.", 0));
