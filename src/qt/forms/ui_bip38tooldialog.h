...
public:
    ...
    void setupUi(QDialog *Bip38ToolDialog)
    {
        ...
        Bip38ToolDialog->resize(700, 371);
        ...
        addressIn_ENC->setMinimumSize(QSize(0, 36));
        addressIn_ENC->setMaximumSize(QSize(16777215, 36));
        ...
        passphraseIn_ENC->setMinimumSize(QSize(0, 36));
        passphraseIn_ENC->setMaximumSize(QSize(16777215, 36));
        ...
        encryptedKeyOut_ENC->setMinimumSize(QSize(0, 36));
        encryptedKeyOut_ENC->setMaximumSize(QSize(16777215, 36));
        QFont font;
        font.setItalic(true);
        ...
        copyKeyButton_ENC->setMinimumSize(QSize(36, 36));
        copyKeyButton_ENC->setMaximumSize(QSize(16777215, 16777215));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/icons/editcopy"), QSize(), QIcon::Normal, QIcon::Off);
        copyKeyButton_ENC->setIcon(icon2);
        copyKeyButton_ENC->setIconSize(QSize(36, 36));
        ...
        encryptedKeyIn_DEC->setMinimumSize(QSize(36, 36));
        ...
        passphraseIn_DEC->setMinimumSize(QSize(36, 36));
        ...
        decryptedKeyOut_DEC->setMinimumSize(QSize(36, 36));
        ...
        addressOut_DEC->setMinimumSize(QSize(36, 36));
    ...
    void retranslateUi(QDialog *Bip38ToolDialog)
    {
        ...
        infoLabel_ENC->setText(QApplication::translate("Bip38ToolDialog", "Enter a EREX Address that you would like to encrypt using BIP 38. Enter a passphrase in the middle box. Press encrypt to compute the encrypted private key.", 0));
        label_5->setText(QApplication::translate("Bip38ToolDialog", "Address:", 0));
#ifndef QT_NO_TOOLTIP
        addressIn_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "The EREX address to sign the message with", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        encryptKeyButton_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "Sign the message to prove you own this EREX address", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        encryptedKeyIn_DEC->setToolTip(QApplication::translate("Bip38ToolDialog", "The EREX address the message was signed with", 0));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("Bip38ToolDialog", "Passphrase: ", 0));
#ifndef QT_NO_TOOLTIP
        decryptKeyButton_DEC->setToolTip(QApplication::translate("Bip38ToolDialog", "Verify the message to ensure it was signed with the specified EREX address", 0));
#endif // QT_NO_TOOLTIP
