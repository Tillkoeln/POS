...
public:
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        payTo->setMinimumSize(QSize(0, 38));
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/icons/address-book@2x"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/icons/editpaste@2x"), QSize(), QIcon::Normal, QIcon::Off);
        pasteButton->setIcon(icon1);
        pasteButton->setIconSize(QSize(40, 40));
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/icons/remove@2x"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        addAsLabel->setMinimumSize(QSize(0, 38));
        ...
        payAmount->setMinimumSize(QSize(0, 38));
        ...
        deleteButton_is->setIconSize(QSize(40, 40));
        ...
        deleteButton_s->setIconSize(QSize(40, 40));
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The EREX address to send the payment to", 0));
#endif // QT_NO_TOOLTIP
        payTo->setPlaceholderText(QString());
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the EREX: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the EREX network.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
