...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        bitcoinAtStartup->setMinimumSize(QSize(36, 36));
        ...
        databaseCache->setMinimumSize(QSize(36, 36));
        ...
        threadsScriptVerif->setMinimumSize(QSize(36, 36));
        ...
        obfuscationRounds->setMinimumSize(QSize(36, 36));
        ...
        anonymizeEREX = new QSpinBox(tabMain);
        anonymizeEREX->setObjectName(QStringLiteral("anonymizeEREX"));
        anonymizeEREX->setMinimumSize(QSize(36, 36));
        anonymizeEREX->setMinimum(100);
        anonymizeEREX->setMaximum(100000);
        anonymizeEREX->setSingleStep(100);
        anonymizeEREX->setValue(1000);

        horizontalLayout->addWidget(anonymizeEREX);
        ...
        coinControlFeatures->setMinimumSize(QSize(36, 36));
        ...
        showMasternodesTab->setMinimumSize(QSize(36, 36));
        ...
        spendZeroConfChange->setMinimumSize(QSize(36, 36));
        ...
        mapPortUpnp->setMinimumSize(QSize(36, 36));
        ...
        allowIncoming->setMinimumSize(QSize(36, 36));
        ...
        connectSocks->setMinimumSize(QSize(36, 36));
        ...
        proxyIp->setMinimumSize(QSize(36, 36));
        ...
        proxyPort->setMinimumSize(QSize(36, 36));
        ...
        minimizeToTray->setMinimumSize(QSize(36, 36));
        ...
        minimizeOnClose->setMinimumSize(QSize(36, 36));
        ...
        lang->setMinimumSize(QSize(36, 36));
        ...
        theme->setMinimumSize(QSize(36, 36));
        ...
        unit->setMinimumSize(QSize(36, 36));
        ...
        digits->setMinimumSize(QSize(36, 36));
        ...
        thirdPartyTxUrls->setMinimumSize(QSize(36, 36));
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start EREX after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start EREX on system login", 0));
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of EREX to keep anonymized", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the EREX client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the EREX network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting EREX.", 0));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/erex-project/erex-project-translations", 0));
