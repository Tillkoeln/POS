...
public:
    ...
    void setupUi(QDialog *HelpMessageDialog)
    {
        ...
        HelpMessageDialog->setWindowTitle(QStringLiteral("EREX - Command-line options"));
        ...
        graphic->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 457, 69));
