...
public:
    ...
    void setupUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        SignVerifyMessageDialog->resize(700, 394);
        ...
        addressIn_SM->setMaximumSize(QSize(16777215, 36));
        QFont font;
        ...
        addressBookButton_SM->setIconSize(QSize(36, 36));
        ...
        pasteButton_SM->setIconSize(QSize(36, 36));
        ...
        signatureOut_SM->setMaximumSize(QSize(16777215, 36));
        QFont font1;
        ...
        copySignatureButton_SM->setIconSize(QSize(36, 36));
        ...
        addressIn_VM->setMaximumSize(QSize(16777215, 36));
        addressIn_VM->setFont(font);
        ...
        addressBookButton_VM->setIconSize(QSize(36, 36));
        ...
        signatureIn_VM->setMinimumSize(QSize(0, 36));
        signatureIn_VM->setMaximumSize(QSize(16777215, 36));
        signatureIn_VM->setFont(font);
    ...
    void retranslateUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        addressIn_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The EREX address to sign the message with", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        signMessageButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this EREX address", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        addressIn_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The EREX address the message was signed with", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        verifyMessageButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified EREX address", 0));
#endif // QT_NO_TOOLTIP
