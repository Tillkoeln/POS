...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EREX features */
        {"erex", "masternode", &masternode, true, true, false},
        {"erex", "listmasternodes", &listmasternodes, true, true, false},
        {"erex", "getmasternodecount", &getmasternodecount, true, true, false},
        {"erex", "masternodeconnect", &masternodeconnect, true, true, false},
        {"erex", "masternodecurrent", &masternodecurrent, true, true, false},
        {"erex", "masternodedebug", &masternodedebug, true, true, false},
        {"erex", "startmasternode", &startmasternode, true, true, false},
        {"erex", "createmasternodekey", &createmasternodekey, true, true, false},
        {"erex", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"erex", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"erex", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"erex", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"erex", "getmasternodescores", &getmasternodescores, true, true, false},
        {"erex", "mnbudget", &mnbudget, true, true, false},
        {"erex", "preparebudget", &preparebudget, true, true, false},
        {"erex", "submitbudget", &submitbudget, true, true, false},
        {"erex", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"erex", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"erex", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"erex", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"erex", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"erex", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"erex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"erex", "checkbudgets", &checkbudgets, true, true, false},
        {"erex", "mnsync", &mnsync, true, true, false},
        {"erex", "spork", &spork, true, true, false},
        {"erex", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"erex", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use erexd, or the -server option to erex-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> erex-cli " + methodname + " " + args + "\n";
}
