Contributing to EREX
============================

The EREX Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the EREX Core build
system and tests. Refer to the documentation in the repository on how to build
EREX Core and how to run the unit and functional tests.
