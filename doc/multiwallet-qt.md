...
In order to support loading of multiple wallets in erex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is erex.cpp.
...
Changes to erex.cpp
----------------------
erex.cpp is the entry point into erex-qt, and as such, will require some minor modifications to provide hooks for
